...
5. uniform full-field re-evaluation under the common Rubric/Evidence Gate
6. upper-rank external/counter-evidence pass as required
7. final evidence corpus freeze
8. independent Claude and Copilot Fresh-read against the same frozen corpus
9. discrepancy review against Rubric/Evidence
